...
<div id="testimonial_text_wap" class="col-xs-9 col-sm-10">
      <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="assets/images/rabindra.jpg" class="img-responsive" alt="Director" />
        </div>
        <div class="col-sm-9">
            <h2>Prof. Dr. Rabindra Nath Shrestha</h2>
            <h3>Director</h3>
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="assets/images/Mahendra.jpg" class="img-responsive" alt="Deputy Director" />
        </div>
        <div class="col-sm-9">
            <h2>Assit. Prof. Mahendra Raj Dhital</h2>
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="assets/images/mandip.jpg" class="img-responsive" alt="Associate Researcher" />
        </div>
        <div class="col-sm-9">
            <h2>Mandip Kr. Thakur</h2>
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="assets/images/binod.jpg" class="img-responsive" alt="Chief Executive Officer" />
        </div>
        <div class="col-sm-9">
            <h2>Tej Binod Pandey</h2>
            <h3>Associate Researcher</h3>
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="assets/images/templatemo_member_03.jpg" class="img-responsive" alt="Associate Researcher" />
        </div>
        <div class="col-sm-9">
            <h2>Samyam Koirala</h2>
            <h3>Associate Researcher</h3>
            <p>Maecenas nec rhoncus orci. Morbi tempus ut leo ac varius. Cras convallis sagittis dignissim. Aenean diam libero, venenatis eu risus eu, tincidunt porttitor orci. Nulla consequat mi et lectus vehicula condimentum. Nulla ullamcorper dolor vehicula dolor interdum, eget fermentum ligula bibendum. Sed vel dolor libero.</p>
        </div>
     </div>
